...
## Exposed
export TOMCAT_SHUTDOWN_PORT_NUMBER="${SHUTDOWN_PORT_NUMBER:-8005}"
export TOMCAT_HTTP_PORT_NUMBER="${HTTP_PORT_NUMBER:-18019}"
export TOMCAT_AJP_PORT_NUMBER="${AJP_PORT_NUMBER:-8009}"
export TOMCAT_HOME="${TOMCAT_HOME:-$TOMCAT_BASE_DIR}"
export TOMCAT_USERNAME="${USERNAME:-user}"
